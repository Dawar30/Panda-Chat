...
export default function AsideItems({ conversations, activeChat, handleThreadClick, showMobileChat, isLoading }) {
  return (
    <aside
              ...
              >
                ...
                <div className="flex flex-col space-y-3 items-end self-end">
                  <span className="text-[10px] font-light text-gray">
                    {conversation.updatedAt ? formatMessageTime(conversation.updatedAt) : "Just now"}
                  </span>
