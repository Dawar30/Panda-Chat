...
import Crossbell from "@/components/svg/crossbell";
import Import from "@/components/svg/import";
import Doubletick from "@/components/svg/doubletick";
import Leftarrow from "@/components/svg/leftarrow";
import { pinnedThreads, chatData } from "@/constants/data";

export default function Messages() {
  const [activeThreadId, setActiveThreadId] = useState("pinned-james");
  const [messages, setMessages] = useState(chatData["pinned-james"]);
  ...
  const currentThread = pinnedThreads.find(
        ...
        >
          <div className="flex flex-col gap-4 p-4 shrink-0">
            {/* <div className="flex items-center gap-3">
              <Image src="/logo.avif" alt="Chat App Logo" width={50} height={50} />
              <h2 className="text-2xl font-st font-bold text-gray-900">Chat App</h2>
            </div> */}
              ...
              {pinnedThreads.map((thread) => (
                ...
                >
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="truncate text-xs text-gray font-regular">
                      {thread.message}
                    </p>
                  </div>
            ...
            <div className="flex items-center gap-3">
              <div>
                <p className="text-[18px] font-medium text-primary-black">
                  {currentThread?.name || "User"}
                </p>
                <p className="text-sm font-regular text-primary">
                  {currentThread?.caseName || "General"}
                </p>
              </div>
            </div>
